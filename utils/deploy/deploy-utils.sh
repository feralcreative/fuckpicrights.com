...
# ============================================================================
# fuckpicrights — Post-deploy management for the NAS container
# ============================================================================
...
Environment:
  SSH_KEY_PATH   Override SSH key path (default: auto-detect ~/.ssh/id_ed25519, then id_rsa, then ssh-agent)
EOF
}
